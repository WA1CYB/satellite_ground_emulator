...
# Generated: Sun Oct 22 18:14:41 2017
##################################################
...
class ground_test_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.offset_temp = offset_temp = -9000
        ...
        self._voice_gain_range = Range(0, 1, .05, .5, 200)
        ...
        self._audio_selection_labels = ('No audio', 'Local HT', 'Sat Rcv ', 'Local HT + Sat', 'IP Out', )
        ...
        self.sr2_dc_iq_offset_0_1_1 = analog.sig_source_c(samp_rate_sr1, analog.GR_COS_WAVE, -9000., 1, 0)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_3_1_win, 7,3,1,1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_2_0_win, 7,0,1,3)
        ...
        self.analog_sig_source_x_2 = analog.sig_source_c(samp_rate_sr2, analog.GR_COS_WAVE, 2**16, .5, 0)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate_sr2, analog.GR_COS_WAVE, 9000, 1, 0)
        ...
        self.connect((self.analog_nbfm_tx_0_0, 0), (self.blocks_complex_to_float_0, 0))    
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_multiply_xx_5, 0))    
        ...
        self.connect((self.blks2_selector_0_2, 0), (self.blocks_multiply_const_vxx_0_0_2, 0))    
        self.connect((self.blks2_selector_1, 0), (self.blocks_add_xx_4, 2))    
        self.connect((self.blocks_add_xx_0, 0), (self.blks2_selector_0_2, 3))    
        ...
        self.connect((self.blocks_multiply_xx_5, 0), (self.blocks_multiply_xx_1, 0))    
        ...
        self.connect((self.low_pass_filter_0_2_0, 0), (self.blks2_selector_0_2, 2))    
        self.connect((self.low_pass_filter_0_2_0, 0), (self.blks2_selector_0_2, 4))    
        self.connect((self.low_pass_filter_0_2_0, 0), (self.blocks_add_xx_0, 0))    
        self.connect((self.low_pass_filter_0_2_0_2_0_0, 0), (self.rational_resampler_xxx_0_0_0_0_0_0_0, 0))    
        self.connect((self.osmosdr_source_0, 0), (self.blocks_multiply_xx_5, 1))    
        ...
        self.connect((self.rational_resampler_xxx_0_1_0, 0), (self.blocks_multiply_xx_0_0, 0))    
        ...
        self.connect((self.rational_resampler_xxx_6, 0), (self.blocks_add_xx_0, 1))    
